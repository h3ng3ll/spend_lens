...
abstract interface class IPriceObservationLocalRepository {
  ...
  Future<void> save(PriceObservation observation, {bool markPending});
  ...
  Future<List<PriceObservation>> getAllIncludingDeleted();

  /// Rows whose `syncStatus` is not `synced`. Drives the push pass.
  Future<List<PriceObservation>> getPending();
  ...
  Future<void> saveAll(List<PriceObservation> items, {bool markPending});
