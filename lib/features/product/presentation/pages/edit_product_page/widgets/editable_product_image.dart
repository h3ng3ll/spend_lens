...
/// The edit sheet's product photo: the current image (or the initial-letter
/// tile) with a small edit badge, tappable to open the source sheet.
///
/// The badge is what makes the affordance discoverable — a bare circular tile
/// gives no hint that it is editable.
class EditableProductImage extends StatelessWidget {
  /// FILENAME of the image to show — never its bytes. See
  /// `ProductImageStore`.
  final String filename;

  /// Drawn as the initial when there is no photo.
  final String productName;
  final VoidCallback onTap;

  /// While true the image shows a spinner instead of the edit badge, and the
