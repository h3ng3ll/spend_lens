...
///
/// Uploading an avatar is network-bound and takes real time. Without this the
/// button simply greyed out and nothing else happened — indistinguishable from
/// a dead button, which is what prompts a user to tap again or back out
/// mid-upload.
///
/// The label names the PHASE rather than saying "please wait": the photo
/// upload is the slow part, and telling the user which step they are waiting
/// on is the difference between a stall and progress.
class SaveProfileButton extends StatelessWidget {
  final bool isSaving;

  /// The OS picker is open, or its result is being read into memory.
  ...
  /// direct result of a tap on this screen, and leaving the button live during
  /// it invites a save that would commit the previous avatar.
  bool get _isBusy => isSaving || isPickingPhoto;
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            ...
            switch (true) {
              _ when isPickingPhoto => lo.processingPhoto,
              _ when isUploadingPhoto => lo.uploadingPhoto,
              _ => lo.savingProfile,
            },
