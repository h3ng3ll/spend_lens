...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String deleteAllBody(num n, String device) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'This removes $nString records, receipt photos, stores and categories from $device. Cloud backups are not affected. This cannot be undone.',
      one:
          'This removes 1 record, receipt photos, stores and categories from $device. Cloud backups are not affected. This cannot be undone.',
    );
    return '$_temp0';
  }
  ...
  String deleteStoreBody(num n) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'This store has $nString linked records. Deleting the store deletes those records too. This cannot be undone.',
      one:
          'This store has 1 linked record. Deleting the store deletes that record too. This cannot be undone.',
    );
    return '$_temp0';
  }
  ...
  @override
  String get analyticsEmptyMonthTitle => 'Nothing in this month';
  ...
  String purchaseCount(num n) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      n,
      locale: localeName,
      other: '$nString purchases',
      one: '$nString purchase',
    );
    return '$_temp0';
  }
  ...
  @override
  String get changeProductImage => 'Change photo';

  @override
  String get removeProductImage => 'Remove photo';
  ...
  String storeMeta(num v, num p) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      v,
      locale: localeName,
      other: '$vString visits',
      one: '1 visit',
    );
    String _temp1 = intl.Intl.pluralLogic(
      p,
      locale: localeName,
      other: '$pString products',
      one: '1 product',
    );
  ...
  String cheapestOf(num n) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      n,
      locale: localeName,
      other: 'Cheapest of $nString stores',
      one: 'Cheapest of 1 store',
    );
    return '$_temp0';
  }
  ...
  String tCsv(num count) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Spreadsheet ready · $countString rows',
      one: 'Spreadsheet ready · 1 row',
    );
    return '$_temp0';
  }
  ...
  @override
  String get scanStatusUnavailable => 'Couldn\'t check';
  ...
  String tImported(num n, num m) {
    ...
    String _temp0 = intl.Intl.pluralLogic(
      n,
      locale: localeName,
      other: '$nString receipts',
      one: '1 receipt',
    );
    String _temp1 = intl.Intl.pluralLogic(
      m,
      locale: localeName,
      other: '$mString expenses',
      one: '1 expense',
    );
    return 'Backup restored · $_temp0, $_temp1';
  }

  @override
  String get importMalformed => 'That file isn\'t a valid backup.';
  ...
  @override
  String get syncRetry => 'Tap to retry';

  @override
  String get syncDisabled => 'Sign in to back up';
  ...
  @override
  String get deleteScopeTitle => 'Delete from where?';

  @override
  String get deleteScopeLocal => 'This device only';

  @override
  String get deleteScopeRemote => 'Cloud only';

  @override
  String get deleteScopeBoth => 'This device and the cloud';
  ...
  String premiumUpgradeSubtitle(String quota) {
    return 'Unlimited history, multi-device sync and $quota of cloud storage.';
  }
  ...
  @override
  String get planMonthlyPrice => '€2.99 / month';

  @override
  String get planYearlyPrice => '€24.99 / year';

  @override
  String get planYearlyNote => '2 months free';

  @override
  String get planBestValue => 'Best value';

  @override
  String get premiumFeatureHistory => 'Unlimited receipt history';

  @override
  String get premiumFeatureSync => 'Sync across your devices';

  @override
  String premiumFeatureStorage(String quota) {
    return '$quota of cloud storage';
  }
  ...
  @override
  String get premiumRestoreNothing => 'No previous purchase found.';
